@testset "feynmanIntegral.jl" begin
    ...
    @test feynman_integral_degree_sum_order(x,q,G,Ω,[1,3])==12*q[2]^6 + 76*q[2]^4*q[3]^2 + 4*q[2]^4*q[5]^2 + 4*q[2]^4*q[6]^2 + 76*q[2]^2*q[3]^4 + 16*q[2]^2*q[3]^2*q[5]^2 + 16*q[2]^2*q[3]^2*q[6]^2 + 4*q[2]^2*q[3]^2 + 12*q[3]^6 + 4*q[3]^4*q[5]^2 + 4*q[3]^4*q[6]^2
    ...
    @test feynman_integral_degree_sum(x,q,G,[1,2])==8*q[1]^4 + 8*q[2]^2*q[3]^2 + 8*q[4]^4 + 8*q[5]^2*q[6]^2
    @test feynman_integral_degree_sum_order(x,q,G,Ω,[1,2])==4*q[2]^2*q[3]^2
    @test substitute(q,feynman_integral_degree_sum(x,q,G,4))==25344*q[1]^8 + 1792*q[1]^6 + 32*q[1]^4
    @test  substitute(q,0)==0
